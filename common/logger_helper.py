...
# Convenience functions for common log levels with trace
def info_with_trace(
    logger: logging.Logger, msg: str, trace_id: str, correlation_id: Optional[str] = None, *args, **kwargs
) -> None:
    """Log info message with trace context."""
    log_with_trace(logger, logging.INFO, msg, trace_id, correlation_id, *args, **kwargs)
...
def debug_with_trace(
    ...
    log_with_trace(logger, logging.DEBUG, msg, trace_id, correlation_id, *args, **kwargs)


def warning_with_trace(
    logger: logging.Logger, msg: str, trace_id: str, correlation_id: Optional[str] = None, *args, **kwargs
) -> None:
    """Log warning message with trace context."""
    log_with_trace(logger, logging.WARNING, msg, trace_id, correlation_id, *args, **kwargs)
...
def error_with_trace(
    ...
    log_with_trace(logger, logging.ERROR, msg, trace_id, correlation_id, *args, **kwargs)


def exception_with_trace(
    logger: logging.Logger, msg: str, trace_id: str, correlation_id: Optional[str] = None, *args, **kwargs
) -> None:
