...
4. [Validation Modes: Before vs After](#validation-modes-before-vs-after)
    ...
    - [mode='after'](#modeafter-default)
5. [Best Practices](#best-practices)
    - [Separation of Concerns](#1-separation-of-concerns)
    - [Use Field for Simple Constraints](#2-use-field-for-simple-constraints)
    - [Explicit Error Messages](#3-explicit-error-messages)
    - [Use Alias for Frontend Compatibility](#4-use-alias-for-frontend-compatibility)
6. [Django Ninja Integration](#django-ninja-integration)
    - [Schemas vs Models](#schemas-vs-models)
    - [Using ModelSchema](#using-modelschema)
    - [Handling Nested Data](#handling-nested-data)
    - [Handling Lists of Nested Objects](#handling-lists-of-nested-objects)
    - [Summary Table](#summary-table-when-to-use-what)
7. [Using Schemas in Views (DRF Comparison)](#using-schemas-in-views-drf-comparison)
    - [Input Validation](#1-input-validation)
    - [Accessing Validated Data](#2-accessing-validated-data)
    - [Saving Data (Model Mapping)](#3-saving-data-model-mapping)
    - [Response Serialization](#4-response-serialization)
    - [DRF vs Ninja Cheat Sheet](#5-drf-vs-ninja-cheat-sheet)
8. [Execution Flow & Dependency Injection](#execution-flow--dependency-injection)
    - [Request Lifecycle](#request-lifecycle)
    - [Dependency Injection](#dependency-injection)
9. [Running Logic Before Validation](#running-logic-before-validation)
    - [Authentication & Permissions](#1-authentication--permissions-the-gatekeeper)
    - [Modifying Input Data](#2-modifying-input-data)
